	...
	public Breakout() {
		...
		instructions.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				instructionsScreen = new JFrame("Instrucciones");
		...
		scores.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				JLabel score1 = new JLabel("Puntuacion 1");
				JLabel score2 = new JLabel("Puntuacion 2");
				JTextArea score1Text = new JTextArea();
				JTextArea score2Text = new JTextArea();
				JButton compare = new JButton("Comparar puntuaciones");
				JLabel compareLabel = new JLabel();
				JButton removeH = new JButton("Quitar mayor");
				JButton removeL = new JButton("Quitar menor");
				JButton save = new JButton("Guardar puntuaciones");
				JButton load = new JButton("Cargar puntuaciones");
				...
				scoresFrame.setLocation(525, 300);
				...
				compare.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							e3.getStackTrace();
							compareLabel.setText("Formato Incorrecto");
